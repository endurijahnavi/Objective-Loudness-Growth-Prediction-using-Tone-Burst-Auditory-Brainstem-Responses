...
if (length(boundaries)<(params.N-1))
    ...
    %========== edited by vineet 15/6/22
    boundaries=EWT_Boundaries_Completion(boundaries,params.N-1,MM);
end
...
%===============changed by Vineet for desired EWT Computation
%mfb = EWT_Meyer_FilterBank(readmatrix('mean_boundaries_F1_N1_R1.txt'),length(ff));
